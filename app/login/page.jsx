        ...
        <div className='z-30 md:w-[60%] w-[90%] text-center '>
          ...
          <div className='w-full flex items-center justify-center ' style={{ margin: '4px' }}>
            <div style={{ padding: '10px' }} className='md:w-[50%] w-[90%] bg-black/70  shadow-xl shadow-black rounded-sm backdrop-blur-lg '>
              ...
              <div style={{ marginTop: '15px', marginBottom: '15px' }} className='w-full h-[0.5px] bg-zinc-700 flex items-center justify-center'>
                <div className='w-full h-[0.5px] bg-zinc-700'></div>
                ...
                logger === 'SignUp'?
                 <div className='flex items-center justify-around'>
                  ...
                  <SignUpButton mode="modal" >
                    <button style={{padding:'10px'}} className='rounded-md hover:bg-zinc-900 cursor-pointer select-none bg-zinc-800 font-bold '>Continue with Google OR Facebook</button>
                  </SignUpButton>
              ...
              <div className='flex items-center justify-around'>
                ...
                <button style={{padding:'10px'}} className='rounded-md cursor-pointer select-none bg-zinc-800 font-bold '>Continue with Google OR Facebook</button>
                </SignInButton>
